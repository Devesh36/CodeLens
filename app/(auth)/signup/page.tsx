      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="rounded-2xl border border-cyan-500/15 bg-linear-to-b from-slate-900/85 to-slate-950/85 backdrop-blur-xl p-6 sm:p-8 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label htmlFor="name" className="block text-xs text-slate-400 uppercase tracking-[0.12em] font-semibold mb-2">
                Full Name
              </label>
            ...
            <div>
              <label htmlFor="password" className="block text-xs text-slate-400 uppercase tracking-[0.12em] font-semibold mb-2">
                Password
              </label>
              <div className="relative">
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-xs text-slate-400 uppercase tracking-[0.12em] font-semibold mb-2">
                Confirm Password
              </label>
              <div className="relative">
                <Lock size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-500" />
